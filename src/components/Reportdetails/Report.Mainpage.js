...
function ReportMainpage() {
  ...
  const columnDefs = [
    { headerName: 'ID', field: 'empId', width: "90px", filter:'true'},
    ...
    { headerName: 'LeetRanking', field: 'leetRanking', width: "240px", hide: !showColumns.Rating },
    { headerName: 'Easy', field: 'easy', width: "80px", hide: !showColumns.Complexity },
    { headerName: 'Medium', field: 'medium', width: "90px", hide: !showColumns.Complexity },
    { headerName: 'Hard', field: 'hard', width: "80px", hide: !showColumns.Complexity },
      ...
      <div className="Nav">
        ...
        <div className="Border-container1" style={{ justifyContent: "between", display: "flex" }}>
          ...
          <div className="Export-divide" >
            ...
            {res1 && dataToExport ? (
              <button className="btn btn-primary" onClick={() => exportToExcel(res1, "MyTable")} style={{ border: "none", marginLeft: "560px", marginBottom: "-100px" }}>
